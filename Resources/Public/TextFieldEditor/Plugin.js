(() => {
  ...
  // TextFieldEditor/style.module.css
  var _default;
  var init_ = __esm({
    "TextFieldEditor/style.module.css"() {
      _default = {};
...
`;
  ...
  // TextFieldEditor/TextFieldEditor.js
  var import_react4, import_react_redux, import_prop_types, import_react_ui_components, import_lodash, import_neos_ui_decorators, import_neos_ui_redux_store, defaultOptions, busySyncIconProps, TextField;
  var init_TextFieldEditor = __esm({
    "TextFieldEditor/TextFieldEditor.js"() {
      ...
      TextField = class extends import_react4.PureComponent {
        constructor() {
          super(...arguments);
          this.state = {
            isBusy: false
        ...
        render() {
          ...
          const placeholder = options && options.placeholder && i18nRegistry.translate((0, import_lodash.default)(options.placeholder));
          ...
          )), showAiButton && finalOptions.buttonStyle === "slim" ? /* @__PURE__ */ import_react4.default.createElement("div", { style: { flexGrow: 0 } }, /* @__PURE__ */ import_react4.default.createElement(
            import_react_ui_components.IconButton,
            {
              id: "neos-UriPathSegmentEditor-sync",
              size: "regular",
              icon: "magic",
              iconProps: this.state.isBusy ? busySyncIconProps : void 0,
              onClick: this.generateText,
              className: _default.aiButton,
              disabled: this.state.isBusy,
              style: "neutral",
              hoverStyle: "clean",
              title: i18nRegistry.translate("JvMTECH.AIToolkit:Main:general.generate.cta")
            }
          )) : null), showAiButton && finalOptions.buttonStyle !== "slim" ? /* @__PURE__ */ import_react4.default.createElement(GenerateButton_default, { onClick: this.generateText }) : null);
        }
      };
      TextField.propTypes = {
  ...
  // TextFieldEditor/manifest.js
  var manifest_exports = {};
  var init_manifest2 = __esm({
    "TextFieldEditor/manifest.js"() {
      init_dist();
      init_TextFieldEditor();
      dist_default("JvMTECH.AIToolkit:TextFieldEditor", {}, (globalRegistry) => {
